...
support])
   ...
   AC_LANG_SAVE
   AC_LANG_CPLUSPLUS
   AC_CHECK_LIB(atheos, main, [LIBS="$LIBS -latheos -lstdc++"])
   AC_LANG_RESTORE
...
LIBQT="$LIBQT $X_PRE_LIBS $LIBSM $LIBSOCKET"
...
LIB_QT="$kde_int_qt "'$(LIBPNG) $(LIBJPEG) $(LIB_X11) $(LIBSM)'
AC_SUBST(LIB_QT)
