...
# Move the CUPS PPDs
package unregister $WORKING_COPY/image/system/resources/cups/1.3.4/ $WORKING_COPY/image/system/index/
...
package register $WORKING_COPY/image/system/resources/cups/1.3.4/ $WORKING_COPY/image/system/index/
