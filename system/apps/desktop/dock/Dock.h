...
public:
	...
	virtual void AddPlugin( os::String zPath );
	virtual void UpdatePlugins();
	virtual void DeletePlugin( os::DockPlugin* pcPlugin );
	virtual void ActivateWindow( int32 nWindow );
	virtual void UpdateWindows( os::Message* pcWindows, int32 nCount );
