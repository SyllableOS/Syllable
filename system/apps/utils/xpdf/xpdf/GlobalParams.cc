...
static struct {
  ...
  {"Courier",               "VeraMono.ttf"},
  {"Courier-Bold",          "VeraMoBd.ttf"},
  {"Courier-BoldOblique",   "VeraMoBI.ttf"},
  {"Courier-Oblique",       "VeraMoIt.ttf"},
  {"Helvetica",             "Vera.ttf"},
  ...
  {"Times-BoldItalic",      "VeraSeBd.ttf"},
  {"Times-Italic",          "VeraSe.ttf"},
  {"Times-Roman",           "VeraSe.ttf"},
