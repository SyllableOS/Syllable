...
/*
** name:       SetConfigFileNames
** purpose:    Sets specific directories and files to ~/<directory or file>
** parameters: 
** returns:   
*/
...
/*
** name:       mounteddrives
** purpose:    Puts specific information(like the size of a partition) into a struct for later use
** parameters: 
** returns:    mounted_drives - a struct that holds info about a partition
*/
...
/*
** name:       authorize
** purpose:    Tells whether the login password that was typed into the login screen is the right
**             password for this name
** parameters: Pointer that holds the login name
** returns:    
*/
