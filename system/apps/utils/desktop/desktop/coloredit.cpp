...
/*
** name:       get_max_width
** purpose:    Gets the max width of the point
** parameters: Point
** returns:    Point
*/
...
/*
** name:       ColorEdit Constructor
** purpose:    Constructs ColorEdit
** parameters: Rect(holds the size of the coloredit ), const char* (holds the name
**			   of the coloredit), Color32_s(holds the color for the view) 
** returns:
*/
...
/*
** name:       ColorEdit::HandleMessage
** purpose:    Handles the message in the coloredit
** parameters: Message(holds message passed by the coloredit)
** returns:
*/
...
/*
** name:       ColorEdit::SetValue
** purpose:    Sets the color of the ColorEdit View
** parameters: Color32_s(holds the color passed to it)
** returns:
*/
...
/*
** name:       ColorEdit::GetValue
** purpose:    Gets the color of the ColorEdit
** parameters: 
** returns:	   Color32_s
*/
...
/*
** name:       ColorEdit::AllAttached
** purpose:    Executes after the ColorEdit is initialized
** parameters: 
** returns:	   
*/
...
/*
** name:       ColorEdit::GetPreferredSize
** purpose:    Gets the preferred size of the coloredit view
** parameters: 
** returns:	   Point
*/
...
/*
** name:       ColorEdit::FrameSized
** purpose:    Basically attaches everything to the ColorEdit(with specific sizes)
** parameters: Point
** returns:	   
*/
...
/*
** name:       ColorEdit::Paint
** purpose:    Paints the colors on to the ColorEdit View
** parameters: Rect(size of ColorEdit)
** returns:	   
*/
