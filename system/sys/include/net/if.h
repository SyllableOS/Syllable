...
/*typedef PacketBuf_s* ni_read(); */
typedef int ni_deinit();
typedef int ni_write( Route_s* psRoute, ipaddr_t pDstAddress, PacketBuf_s* psBuf );
...
{
    char	      	ni_zName[128];
    NetInterfaceOps_s*	ni_psOps;
    void*		ni_pInterface;
    ipaddr_t		ni_anIpAddr;
    ipaddr_t		ni_anSubNetMask;
    int			ni_nMTU;		/* Max Transmition Unit */
//    union {
//	const EthDriverOps_s* psEth;
//    } ni_uDriverOps;;
};
