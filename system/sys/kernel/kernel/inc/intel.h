...
static const uint32_t PTE_ACCESSED	= 0x020;  ///< the page has been accessed (R or W)
static const uint32_t PTE_DIRTY		= 0x040;  ///< the page has been written to
static const uint32_t PTE_AVAILABLE	= 0xE00;  ///< free for system use (NOT APPLICATIONS)
