...
Spinner::Spinner( Rect cFrame, const char *pzName, double vValue, Message * pcMessage, uint32 nResizeMask, uint32 nFlags ):Control( cFrame, pzName, "", pcMessage, nResizeMask, nFlags | WID_FULL_UPDATE_ON_RESIZE ), m_cStrFormat( "%.2f" )
{
	m_vStep = 0.1f;
	m_vSpeedScale = 1.0f;
