...
Rect Variant::AsRect() const
{
	...
	case T_IPOINT:
	    return( Rect( static_cast<Point>(*reinterpret_cast<IPoint*>(m_uData.sBuffer.pBuffer)),
			  static_cast<Point>(*reinterpret_cast<IPoint*>(m_uData.sBuffer.pBuffer)) ) );
	case T_RECT:
...
IRect Variant::AsIRect() const
{
    ...
    {
	case T_POINT:
	    return( IRect( static_cast<IPoint>(*reinterpret_cast<Point*>(m_uData.sBuffer.pBuffer)),
			   static_cast<IPoint>(*reinterpret_cast<Point*>(m_uData.sBuffer.pBuffer)) ) );
	case T_IPOINT:
...
bool Variant::operator==( const Variant& cOther ) const
{
	...
	case T_INT16:
	case T_INT32:
	    return( (cOther.m_eType == T_INT8  && m_uData.nInt32 == cOther.m_uData.nInt32) ||
		    (cOther.m_eType == T_INT16 && m_uData.nInt32 == cOther.m_uData.nInt32) ||
		    (cOther.m_eType == T_INT32 && m_uData.nInt32 == cOther.m_uData.nInt32) ||
		    (cOther.m_eType == T_INT64 && m_uData.nInt32 == cOther.m_uData.nInt64) ||
		    (cOther.m_eType == T_BOOL && bool(m_uData.nInt32) == cOther.m_uData.bBool) ||
		    (cOther.m_eType == T_FLOAT && float(m_uData.nInt32) == cOther.m_uData.vFloat) ||
		    (cOther.m_eType == T_DOUBLE && double(m_uData.nInt32) == cOther.m_uData.vDouble) );
	case T_INT64:
	    return( (cOther.m_eType == T_INT64 && m_uData.nInt64 == cOther.m_uData.nInt64) ||
		    (cOther.m_eType == T_INT8  && m_uData.nInt64 == cOther.m_uData.nInt32) ||
		    (cOther.m_eType == T_INT16 && m_uData.nInt64 == cOther.m_uData.nInt32) ||
		    (cOther.m_eType == T_INT32 && m_uData.nInt64 == cOther.m_uData.nInt32) ||
		    (cOther.m_eType == T_BOOL && bool(m_uData.nInt64) == cOther.m_uData.bBool) ||
		    (cOther.m_eType == T_FLOAT && float(m_uData.nInt64) == cOther.m_uData.vFloat) ||
		    (cOther.m_eType == T_DOUBLE && double(m_uData.nInt64) == cOther.m_uData.vDouble) );
	case T_BOOL:
	    return( (cOther.m_eType == T_BOOL && m_uData.bBool == cOther.m_uData.bBool) ||
		    (cOther.m_eType == T_INT8  && m_uData.bBool == cOther.m_uData.nInt32) ||
		    (cOther.m_eType == T_INT16 && m_uData.bBool == cOther.m_uData.nInt32) ||
		    (cOther.m_eType == T_INT32 && m_uData.bBool == cOther.m_uData.nInt32) ||
		    (cOther.m_eType == T_INT64 && m_uData.bBool == cOther.m_uData.nInt64) ||
		    (cOther.m_eType == T_FLOAT && m_uData.bBool == (cOther.m_uData.vFloat!=0.0f)) ||
		    (cOther.m_eType == T_DOUBLE && m_uData.bBool == (cOther.m_uData.vDouble!=0.0)) );
	case T_FLOAT:
	    return( (cOther.m_eType == T_FLOAT && m_uData.vFloat == cOther.m_uData.vFloat) ||
		    (cOther.m_eType == T_DOUBLE && double(m_uData.vFloat) == cOther.m_uData.vDouble) ||
		    (cOther.m_eType == T_INT8  && m_uData.vFloat == float(cOther.m_uData.nInt32)) ||
		    (cOther.m_eType == T_INT16 && m_uData.vFloat == float(cOther.m_uData.nInt32)) ||
		    (cOther.m_eType == T_INT32 && m_uData.vFloat == float(cOther.m_uData.nInt32)) ||
		    (cOther.m_eType == T_INT64 && m_uData.vFloat == float(cOther.m_uData.nInt64)) ||
		    (cOther.m_eType == T_BOOL && (m_uData.vFloat != 0.0f) == cOther.m_uData.bBool) );
	case T_DOUBLE:
	    return( (cOther.m_eType == T_DOUBLE && m_uData.vDouble == cOther.m_uData.vDouble) ||
		    (cOther.m_eType == T_FLOAT && m_uData.vDouble == double(cOther.m_uData.vFloat)) ||
		    (cOther.m_eType == T_INT8  && m_uData.vDouble == double(cOther.m_uData.nInt32)) ||
		    (cOther.m_eType == T_INT16 && m_uData.vDouble == double(cOther.m_uData.nInt32)) ||
		    (cOther.m_eType == T_INT32 && m_uData.vDouble == double(cOther.m_uData.nInt32)) ||
		    (cOther.m_eType == T_INT64 && m_uData.vDouble == double(cOther.m_uData.nInt64)) ||
	...
	case T_RAW:
	    return( cOther.m_eType == T_RAW &&
		    cOther.m_uData.sBuffer.nSize == m_uData.sBuffer.nSize &&
		    memcmp( cOther.m_uData.sBuffer.pBuffer, m_uData.sBuffer.pBuffer, m_uData.sBuffer.nSize ) == 0 );
	default:
	    return( false );
    }    
}
...
status_t Variant::Unflatten( const void* pBuffer, size_t nBufSize )
{
	...
	case T_STRING:
	{
	    ...
	    memcpy( m_uData.pzString, pBuffer, m_uData.sBuffer.nSize );
	    break;
	}
	case T_IRECT:
