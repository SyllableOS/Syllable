...
int AppserverConfig::LoadConfig( FILE* hFile, bool bActivateConfig )
{
	...
	if ( match_name( "Desktop", zLineBuf ) ) {
	    ...
	    if ( sscanf( zLineBuf, "Desktop %d = %d %d %f %f %f %f %f %15s %1023s\n",
			 &nDesktop, &nWidth, &nHeight, &sMode.m_vHPos, &sMode.m_vVPos,
			 &sMode.m_vHSize, &sMode.m_vVSize, &sMode.m_vRefreshRate, zColorSpace, zBackDropPath ) == 10 ) {
		bValid = true;
...
int AppserverConfig::SaveConfig()
{
	...
	{
	    case CS_RGB32:	pzColorSpace = "RGB32";  break;
	    case CS_RGB24:	pzColorSpace = "RGB24";  break;
	    case CS_RGB16:	pzColorSpace = "RGB16";  break;
	    case CS_RGB15:	pzColorSpace = "RGB15";  break;
	    case CS_CMAP8:	pzColorSpace = "CMAP8";  break;
	    case CS_GRAY8:	pzColorSpace = "GRAY8";  break;
	    case CS_GRAY1:	pzColorSpace = "GRAY1";  break;
	    case CS_YUV422:	pzColorSpace = "YUV422"; break;
	    case CS_YUV411:	pzColorSpace = "YUV411"; break;
	    case CS_YUV420:	pzColorSpace = "YUV420"; break;
	    case CS_YUV444:	pzColorSpace = "YUV444"; break;
	    case CS_YUV9:	pzColorSpace = "YUV9";   break;
	    case CS_YUV12:	pzColorSpace = "YUV12";  break;
	    default:	        pzColorSpace = "INV";    break;
	}
    
	fprintf( hFile, "Desktop %02d = %4d %4d %.2f %.2f %.2f %.2f %.2f %6s \"%s\"\n", i,
		 sMode.m_nWidth, sMode.m_nHeight, sMode.m_vHPos, sMode.m_vVPos, sMode.m_vHSize, sMode.m_vVSize,
		 sMode.m_vRefreshRate, pzColorSpace, cBackdropPath.c_str() );
    }
