...
static void draw_line16( SrvBitmap* pcBitmap, const IRect& cClip,
...
static void invert_line16( SrvBitmap* pcBitmap, const IRect& cClip,
...
static void invert_line15( SrvBitmap* pcBitmap, const IRect& cClip,
			   int x1, int y1, int x2, int y2 )
{
    int nODeltaX = abs( x2 - x1 );
    int nODeltaY = abs( y2 - y1 );
...
static void draw_line32( SrvBitmap* pcBitmap, const IRect& cClip,
...
static void invert_line32( SrvBitmap* pcBitmap, const IRect& cClip,
			   int x1, int y1, int x2, int y2 )
{
    int nODeltaX = abs( x2 - x1 );
    int nODeltaY = abs( y2 - y1 );
...
bool DisplayDriver::DrawLine( SrvBitmap* psBitmap, const IRect& cClipRect,
