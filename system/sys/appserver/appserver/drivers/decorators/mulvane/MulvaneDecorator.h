...
#ifndef __F_MULVANEDECORATOR_H__
#define __F_MULVANEDECORATOR_H__
...
class MulvaneDecorator : public os::WindowDecorator
{
public:
	MulvaneDecorator( Layer* pcLayer, uint32 nWndFlags );
	virtual ~MulvaneDecorator();
...
#endif // __F_MULVANEDECORATOR_H__
