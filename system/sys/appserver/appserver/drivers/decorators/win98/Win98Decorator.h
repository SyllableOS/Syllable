...
#ifndef __F_WIN98DECORATOR_H__
#define __F_WIN98DECORATOR_H__
...
class Win98Decorator : public os::WindowDecorator
{
public:
    Win98Decorator( Layer* pcLayer, uint32 nWndFlags );
    virtual ~Win98Decorator();
