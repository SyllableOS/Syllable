...
)
{
    ...
    /* DMA instances for video overlay */
    pNv->PRAMIN[0x0010] = 0x80000018;
    pNv->PRAMIN[0x0011] = 0x8000120a;
    pNv->PRAMIN[0x0012] = 0x80000019;
    pNv->PRAMIN[0x0013] = 0x8000120b;
    pNv->PRAMIN[0x0014] = 0x8000001a;
    pNv->PRAMIN[0x0015] = 0x8000120c;
    pNv->PRAMIN[0x0016] = 0x8000001b;
    pNv->PRAMIN[0x0017] = 0x8001120d;
    ...
    /* Overlay notifier */
    pNv->PRAMIN[0x0828] = 0x0002303e;
    pNv->PRAMIN[0x0829] = 0x000000ff;
    pNv->PRAMIN[0x082a] = 0 | 0x00000002;
    pNv->PRAMIN[0x082b] = 0xffffffff;
    
    /* Overlay out */
    pNv->PRAMIN[0x082c] = 0x0000303d;
    pNv->PRAMIN[0x082d] = ( 720 * 576 * 4 );
    pNv->PRAMIN[0x082e] = 0 | 0x00000002;
    pNv->PRAMIN[0x082f] = 0xffffffff;
    
    /* Overlay in */
    pNv->PRAMIN[0x0830] = 0x0002303e;
    pNv->PRAMIN[0x0831] = ( 720 * 576 * 4 );
    pNv->PRAMIN[0x0832] = 0 | 0x00000002;
    pNv->PRAMIN[0x0833] = 0xffffffff;

	/* Overlay contect */
    pNv->PRAMIN[0x0834] = 0x00000039;
    pNv->PRAMIN[0x0835] = 0x120a0000;
    pNv->PRAMIN[0x0836] = 0x120b120c;
    pNv->PRAMIN[0x0837] = 0x00000000;
